...
\fancyhead[C]{ \today\ $\bullet$ Ejercicio evaluación LPO} % Custom header text
...
\title{\vspace{-15mm}\fontsize{24pt}{10pt}\selectfont\textbf{Ejercicio evaluación LPO}} % Article title
